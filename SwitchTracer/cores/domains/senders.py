...
from SwitchTracer.cores.compents.registers import _static_register, SdcRegister
from SwitchTracer.universal.exceptions import SettingErrors, KernelWaresSettingsErrors
