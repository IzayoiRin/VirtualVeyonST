from SwitchTracer.universal.exceptions import AppRuntimeErrors, IllegalParametersErrors
...
class ThreadPoolCallbackBase(object):
    ...
    def __getitem__(self, item, raise_=False):
        ...
        if raise_:
            raise IllegalParametersErrors("Illegal handler: %s" % item)
