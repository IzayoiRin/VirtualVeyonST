...
from SwitchTracer.universal.exceptions import SettingErrors, ConnectionErrors, ImportedErrors, CodingErrors
...
if __name__ == '__main__':
    s = base64_switcher("encode", return_type="utf-8")(r"C:\izayoi\prj_veyon\VirtualVeyonST\veyon\PySwitchTracer\tests")
    print(s)
